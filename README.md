...
| ------ | ------ | ------ |
| requestType | Тип заяви. Можливі варінтаи: 9 => Витяг з ДЗК про земельну ділянку; 12 => Викопіювання з картографічної основи ДЗК, кадастрової карти (плану); 48 => Нормативна грошова оцінка земельної ділянки (с/г призначення за межами населених пунктів)  | Так |
...
| type_user_choice | Тип особи. Можливі варіанти: 'civil' => Фізична особа; 'legal' => 'Юридична особа' | Так |
...
**Додатковий набір даних для Паспорт громадянина України у формі картки.**
...
| Ключ | Опис |
| ------ | ------ |
| request_num | Номер створеної заяви ЗВ-{{request_num}}|
| date | Дата формування заяви |
| redirect_url | Посилання для сплати послуги(елемент відсутній при безоплатній послузі) |
| request_type_text | Короткий опис послуги |
| request_type_price_base | Сума до сплати(елемент відсутній при безоплатній послузі) |
| request_type_price_fee | Комісія банку(елемент відсутній при безоплатній послузі) |
